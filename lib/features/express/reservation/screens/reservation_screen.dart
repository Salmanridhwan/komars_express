...
class _ReservationScreenState extends State<ReservationScreen> {
  ...
  Future<void> _submit() async {
    ...
    final conflicts = await _reservationDao.getByTableAndDate(
      _selectedTable!.id!,
      dateStr,
    );
    ...
    if (hasConflict) {
      ...
      _showSnack(
        'Meja sudah terpesan. Pilih waktu atau meja lain.',
        isError: true,
      );
      return;
    }
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 4),
        Text(
          'Tentukan jam mulai dan selesai',
          style: TextStyle(
            fontFamily: 'Outfit',
            fontSize: 13,
            color: isDark
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: AppColors.secondaryOrangeLight.withValues(alpha: 0.5),
            ),
          ),
          child: const Row(
            children: [
